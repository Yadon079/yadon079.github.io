...
public class EnumSetEx {
    public static void main(String[] args) {
        ...
        EnumSet weekday = EnumSet.of(Week.MON, Week.TUE, Week.WEN, Week.TUS, Week.FRI);

        System.out.println("> 특정 원소만 출력(평일)");
        System.out.println(weekday);
        System.out.println();

        System.out.println("> 평일을 제외하고 출력");
        System.out.println(EnumSet.complementOf(weekday));
        System.out.println();

        System.out.println("> 범위 출력(한 주 전체)");
        System.out.println(EnumSet.range(Week.SUN, Week.SAT));
        System.out.println();
    }
}

enum Week {
    SUN, MON, TUE, WEN, TUS, FRI, SAT
}
```
